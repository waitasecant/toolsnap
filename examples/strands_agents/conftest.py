"""
Shared test configuration for the Strands Agents example.

Both test files (test_decorator.py, test_session.py) require:
...
If either is missing every test in this directory is skipped with a clear
message rather than failing with a confusing import or file-not-found error.
"""
...
# Single fixture file used by both test routes.
